class DeveloperToolsPrompts:
    ...
    def tool_extraction_user(query: str, content: str) -> str:
        return f"""Query: {query}
                ...
                Extract a list of specific tool/service names mentioned in this content that are relevant to the "{query}".
    ...
    def tool_analysis_user(company_name: str, content: str) -> str:
        return f"""Company/Tool: {company_name}
                ...
                - language_support: List of programming languages explicitly supported (e.g., Python, Javascript, Rust, Go, etc.)
